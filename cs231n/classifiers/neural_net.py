...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # classifier loss.                                                          #
    #############################################################################
    percent = (np.exp(scores).T / np.sum(np.exp(scores), axis = 1)).T
    loss = 0
    
    for i in range(y.shape[0]):
        loss -= np.log(percent[i, y[i]])
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in range(num_iters):
      ...
      #########################################################################
      self.params['W1'] -= grads['W1']*learning_rate*learning_rate_decay
      self.params['b1'] -= grads['b1']*learning_rate*learning_rate_decay
      self.params['W2'] -= grads['W2']*learning_rate*learning_rate_decay
      self.params['b2'] -= grads['b2']*learning_rate*learning_rate_decay
      #########################################################################
      #                             END OF YOUR CODE                          #
      #########################################################################
